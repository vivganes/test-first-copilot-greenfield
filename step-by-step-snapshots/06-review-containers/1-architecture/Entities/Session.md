...
| loginType   | Enum      | Local, Social                              |
| provider    | String    | Social login provider (e.g., Google, Facebook; optional) |
| providerId  | String    | External provider user ID (optional)        |
...
- Social login sessions are tracked with loginType, provider, and providerId.
